    ...
    >
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Social">
          <div className="flex flex-col space-y-4 text-sm">
            <HoveredLink
              href="https://github.com/ssaketh-ch"
            ...
            <HoveredLink
              href="https://www.linkedin.com/in/sai-saketh-cherukuri-825456250"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <HoveredLink
              href="https://www.instagram.com/ssaketh_ch/"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <HoveredLink
              href="https://medium.com/@ssaketh.2002"
              rel="noopener noreferrer"
              target="_blank"
            >
